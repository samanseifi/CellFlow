...
def config(mode):
    base = {
        ...
        'nutrient_bc_type': 'dirichlet', 'nutrient_bc_value': 20.0,
        ...
        'adhesion_strength': 0.05, 'adhesion_cutoff_factor': 1.3,
...
def draw(ax, sim, title):
    ...
    for c in sim.cells:
        ax.add_patch(Circle(c.position, c.radius, color='limegreen', alpha=0.9,
                            ec='darkgreen', lw=0.2))
